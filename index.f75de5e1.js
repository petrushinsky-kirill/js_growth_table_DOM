...
function checkLength() {
    ...
    addColumn.toggleAttribute("disabled", field.firstElementChild.children.length === 10);
    deleteColumn.toggleAttribute("disabled", field.firstElementChild.children.length === 2);
}
